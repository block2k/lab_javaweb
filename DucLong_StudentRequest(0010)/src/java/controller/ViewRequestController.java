 ...
 * @author ADMIN
 */
@WebServlet(name = "ViewRequestController", urlPatterns = {"/ViewRequest"})
public class ViewRequestController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Request> listR = dao.getRequestTodayByDid(did);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        int did = Integer.parseInt(request.getParameter("did"));
        List<Request> listR = dao.getRequestLast2DayByDid(did);
        request.setAttribute("listR", listR);
        request.getRequestDispatcher("viewrequest.jsp").forward(request, response);
    }
