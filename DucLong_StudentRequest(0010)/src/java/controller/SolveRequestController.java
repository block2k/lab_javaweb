 ...
 * @author ADMIN
 */
@WebServlet(name = "SolveRequestController", urlPatterns = {"/SolveRequest"})
public class SolveRequestController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        Request re = dao.getRequestByRequestId(rid);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        dao.solveRequest(Date.valueOf(closeDate), Integer.parseInt(state), Integer.parseInt(rid));
        dao.solveStudentRequest(solution, solveBy, Integer.parseInt(rid));
