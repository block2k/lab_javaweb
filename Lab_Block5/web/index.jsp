...
<%-- 
    Document   : index
    Created on : Aug 11, 2021, 6:16:56 PM
    Author     : ADMIN
--%>
...
<html lang="en">
                ...
                <div class="modal-content">
                    <form action="product?action=edit" method="POST">
                        ...
                        <div class="modal-body">					
                            <div class="form-group">
                                <label>ID</label>
                                <input type="text" name="productid" id="proId" value="" readonly="" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" name="productname" id="pname" value="" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Image</label>
                                <input type="text" name="productimage" id="pimage" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Price</label>
                                <input type="number" name="productprice" min="0" id="pprice" class="form-control" required>
                            </div>					
                        </div>
                        <div class="modal-footer">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="product?action=delete" method="POST">
                        <input type="text" id="pId" name="productId" hidden="" value="" />
                        <div class="modal-header">						
                            <h4 class="modal-title" id="targetDel">Delete Product ID: </h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        <div class="modal-body">					
    ...
    <script>
        ...
        function editProduct(name, image, price, id) {
