...
GO
/****** Object:  Table [dbo].[Room]    Script Date: 5/24/2021 11:10:47 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Slot]    Script Date: 5/24/2021 11:10:47 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Teacher]    Script Date: 5/24/2021 11:10:47 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TimeTable]    Script Date: 5/24/2021 11:10:47 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Class] ([ClassID], [ClassName]) VALUES (1, N'SE1427')
GO
INSERT [dbo].[Class] ([ClassID], [ClassName]) VALUES (2, N'SE1433')
GO
INSERT [dbo].[Class] ([ClassID], [ClassName]) VALUES (3, N'SE1516')
GO
INSERT [dbo].[Class] ([ClassID], [ClassName]) VALUES (4, N'SE1422')
GO
...
GO
INSERT [dbo].[Teacher] ([TeacherID], [TeacherName], [TeacherCode]) VALUES (1, N'Bui Duc Long', N'LongBD')
GO
...
GO
INSERT [dbo].[TimeTable] ([ID], [Date], [SlotID], [ClassID], [TeacherID], [RoomID]) VALUES (1, CAST(N'2021-05-21' AS Date), 1, 1, 1, 1)
GO
INSERT [dbo].[TimeTable] ([ID], [Date], [SlotID], [ClassID], [TeacherID], [RoomID]) VALUES (2, CAST(N'2021-05-22' AS Date), 2, 2, 2, 2)
GO
INSERT [dbo].[TimeTable] ([ID], [Date], [SlotID], [ClassID], [TeacherID], [RoomID]) VALUES (3, CAST(N'2021-05-23' AS Date), 3, 3, 3, 3)
GO
INSERT [dbo].[TimeTable] ([ID], [Date], [SlotID], [ClassID], [TeacherID], [RoomID]) VALUES (4, CAST(N'2021-05-24' AS Date), 4, 4, 4, 4)
GO
INSERT [dbo].[TimeTable] ([ID], [Date], [SlotID], [ClassID], [TeacherID], [RoomID]) VALUES (10, CAST(N'2021-05-24' AS Date), 1, 1, 1, 1)
GO
